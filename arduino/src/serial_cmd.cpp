...
static void handle_help(const char *)
{
    ...
    Serial.println(F("  WRITE idx x y flags [ACTIVE|INACTIVE] - Write step (default: inactive)"));
    Serial.println(F("  CLEAR [ACTIVE|INACTIVE]               - Clear buffer (default: inactive)"));
    Serial.println(F("  SWAP                                  - Atomically swap active/inactive buffers"));
    Serial.println(F("  DUMP [ACTIVE|INACTIVE]                - Dump buffer (default: inactive)"));
    Serial.println(F("  SIZE n [ACTIVE|INACTIVE]              - Set buffer size (default: inactive)"));
