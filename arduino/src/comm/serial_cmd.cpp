...
// // Command names and help - only command names need to be in PROGMEM for
// parsing const char cmd_write[] PROGMEM = "WRITE"; const char cmd_clear[]
// PROGMEM = "CLEAR"; const char cmd_swap[] PROGMEM = "SWAP"; const char
// cmd_dump[] PROGMEM = "DUMP"; const char cmd_size[] PROGMEM = "SIZE"; const
// char cmd_help[] PROGMEM = "HELP"; const char cmd_config[] PROGMEM = "CONFIG";
...
//     {cmd_config, CMD_CONFIG}, {cmd_eeprom, CMD_EEPROM}, {cmd_flags,
//     CMD_FLAGS}, {cmd_debug, CMD_DEBUG}};
...
//     const char *prog_name = (const char
//     *)pgm_read_word(&command_table[i].name); size_t n = strlen_P(prog_name);
...
//     Serial.println(
//         F("OK - Configuration reset to defaults (use EEPROM WRITE to
//         save)"));
//     break;
