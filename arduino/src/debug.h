...
#define VALIDATE_STEP_SIZE(step_size) VALIDATE_RANGE_CLIP(step_size, MIN_STEP_SIZE, MAX_STEP_SIZE)

// Dwell time validation
#define VALIDATE_DWELL_TIME(dwell) VALIDATE_RANGE_CLIP(dwell, MIN_DWELL_TIME, MAX_DWELL_TIME)
